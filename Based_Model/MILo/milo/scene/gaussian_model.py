...
class GaussianModel:
    ...
    def prune_points(self, mask):
        ...
        self._culling.select_rows_(valid_points_mask)
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent):
        ...
        self._culling.append_rows_(selected_pts_mask)
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, N=2):
        ...
        self._culling.append_rows_(selected_pts_mask, repeat=N)
    ...
    def _new_culling(self, n, num_views):
        self._culling = None
        torch.cuda.empty_cache()
        return _ColumnCulling.zeros(n, num_views)

    def init_culling(self, num_views):
        self._culling = self._new_culling(self._xyz.shape[0], num_views)
    ...
    def visibility_culling(self, scene, render_simp, iteration, args, pipe, background):
        ...
        self._culling = self._new_culling(self._xyz.shape[0], len(views))
